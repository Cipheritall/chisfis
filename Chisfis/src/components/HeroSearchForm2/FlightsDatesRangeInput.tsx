...
export interface FlightsDatesRangeInputProps {
...
const FlightsDatesRangeInput: FC<FlightsDatesRangeInputProps> = ({
  defaultDateValue,
  defaultTimeValue,
  onChange,
  defaultFocus = null,
  ...
  return (
    <div
      className={`FlightsDatesRangeInput relative flex z-10 ${className} ${
