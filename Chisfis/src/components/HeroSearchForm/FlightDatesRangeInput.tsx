...
export interface FlightDatesRangeInputProps {
...
const FlightDatesRangeInput: FC<FlightDatesRangeInputProps> = ({
  defaultDateValue,
  defaultTimeValue,
  onChange,
  defaultFocus = null,
  ...
  return (
    <div
      className={`FlightDatesRangeInput relative flex z-10 ${className}  ${
